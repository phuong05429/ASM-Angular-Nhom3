...
export class PaginatorComponent implements OnInit {
  ...
  @Output() currentPageFn: EventEmitter<any> = new EventEmitter();
  indexPage: number = 1;
  ...
  goLastPage() {
    ...
    this.currentPageFn.emit(this.last_page)
  }
  ...
  goPreviousPage() {
    ...
    if (this.indexPage <= this.last_page && this.indexPage > 1) {
      ...
      this.currentPageFn.emit(this.indexPage)
    }
  }
